...
export const resolvers = {
    Query: {
        getInv_subImage: async (parent, args) => {
            try {
        ...
        getChildInventory: async (parents, args) => {
            try {
    ...
    Mutation: {
        insertNumberOfVisit: async (parent, args) => {
        ...
        insertNumberOfViews: async (parent, args) => {
            try {
                const date_today = new Date();
                const yy = date_today.getFullYear();
                const mm = date_today.getMonth() + 1;
        ...
        insertInventory: async (parent, args) => {
            var date = new Date();
            var YYYY = date.getFullYear();
            var MMMM = date.getMonth();
            var DDDD = date.getDay();
        ...
        insertChildInventory: async (parent, args) => {
            var date = new Date();
            var YYYY = date.getFullYear();
            var MMMM = date.getMonth();
            var DDDD = date.getDay();
        ...
        updateParentInventory: async (parent, args) => {
            var date = new Date();
        ...
        updateChildInventory: async (parent, args) => {
            var date = new Date();
        ...
        saveCropImage: async (parent, args) => {
